...
export default function Home() {
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#f7f6f1] text-[#101c33]">
      ...
      <section id="norway" className="mx-auto max-w-[1240px] px-5 pb-16 lg:px-8">
        <div className="relative overflow-hidden rounded-[1.7rem] bg-[#0b2d57] p-6 text-white shadow-xl shadow-[#0b2d57]/10 md:p-8">
          <div className="pointer-events-none absolute inset-0 opacity-15 [background-image:linear-gradient(rgba(255,255,255,.12)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,.12)_1px,transparent_1px)] [background-size:44px_44px]" />
          <div className="relative grid gap-6 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full border border-[#79f2b0]/30 bg-[#79f2b0]/10 px-3 py-1.5 text-xs font-black uppercase tracking-[.12em] text-[#79f2b0]">
                <Globe2 className="size-3.5" /> Новое направление
              </div>
              <h2 className="mt-4 max-w-3xl text-[clamp(1.9rem,3.5vw,3.2rem)] font-black leading-[1.02] tracking-[-.045em]">
                Норвегия: работа на <span className="text-[#79f2b0]">краболовном судне</span>
              </h2>
              <p className="mt-3 max-w-3xl text-base leading-7 text-white/65">
                Менеджер расскажет о требованиях, графике, документах и условиях актуального набора.
              </p>
            </div>
            <a href="/consultation" className="inline-flex h-12 w-fit shrink-0 items-center justify-center rounded-full bg-[#79f2b0] px-6 text-sm font-black text-[#0d2a22] transition-colors hover:bg-white">
              Узнать условия <ArrowRight className="ml-2 size-4" />
            </a>
          </div>
          <div className="relative mt-6 flex flex-wrap gap-x-7 gap-y-2 border-t border-white/12 pt-5 text-sm">
            <span><span className="text-white/45">Страна:</span> <strong>Норвегия</strong></span>
            <span><span className="text-white/45">Направление:</span> <strong>краболовство</strong></span>
            <span className="text-white/50">Наличие мест и оформление зависят от документов кандидата.</span>
          </div>
        </div>
      </section>
